...
paul = User.create!(nom: "Paul", prenom: "Tremblay", email: "paul@tremblay.com", password: "123456", is_admin: true)
george = User.create!(nom: "George", prenom: "Germain", email: "george@germain.com", password: "123456")
jacque = User.create!(nom: "Jacque", prenom: "Germain", email: "jacque@germain.com", password: "123456")
daniel = User.create!(nom: "Daniel", prenom: "Peterson", email: "daniel@peterson.com", password: "123456")
robert = User.create!(nom: "Robert", prenom: "Skywalker", email: "robert@skywalker.com", password: "123456")
